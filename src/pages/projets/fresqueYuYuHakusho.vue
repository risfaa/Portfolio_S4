...
<template>
    <ProjectPersoPage 
        imgPathHero="/img/mockup_fresque_page_listes_projets/yuyu_hakusho_cover.png" 
        titre="Fresque manga -" 
        sousTitre="YuYu Hakusho"
        textBtn="Retour" 
        link="/projets"
        :imageUrls=imageUrls
        gridImgFull="/img/mockup_yuyu_hakusho_page_fresque/mockup_yuyu_hakusho_fresque2.png"
